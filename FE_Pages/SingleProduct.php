		...
		<div class="top-header">
			<div class="container">
				<div class="top-header-left">
					<ul>
						<li style="background-color:crimson; padding:5px 0px 5px 10px; border:dashed;"><a href="index.php"><b></b></a></li>
...
<div class="col-md-9">
				...
				include("config.php");
				$c_name = $_GET["btn_id"];		
				$display = "Select * from view_table where Cake_name='".$c_name."'";
			...
			?>	
				...
				<img class="etalage_source_image" src="../Admin_Pages/images/<?php echo $row["Cake_Image"]?>" 
                class="img-thumbnail" width="500" />
				  ...
				  <div class="desc1 span_3_of_2">
                    ...
                    <h4>Cake Flavour : <?php echo $row["Cake_flavour"]?></h4>
                    <h4>Cake Description : <?php echo $row["Cake_Des"]?></h4>
                     <form method="get" action="Cart.php">
                     <h4>Enter Quantity:</h4><span><input type="number" value="1" min="1" name="qty" class="form-control" /></span>
                     <input type="hidden" name="id" value="<?php echo $row["Cake_Id"]?>" /><br>
