...
<div class="col-md-12">
                  ...
                  <th >Cake Name</th> 
                   <th >Cake Flavour</th> 
					...
					?>
					 ...
					 $sn++;
					include("config.php");
				$select =  "select * from view_table where Cake_Id = '".$c["id"]."'";
				 $query = mysqli_query($connection,$select);
					 
					 foreach($query as $pro)
					 {
						 $tp = $pro["Cake_Price"] * $c["qty"];
						 $total_amount += $tp;
						 $_SESSION["amount"] = $total_amount;
						 
					 ?>
                     
                     <td><?php echo $pro["Cake_name"]?></td>
                       <td><?php echo $pro["Cake_flavour"]?></td>
                         <td><?php echo $pro["Cat_Name"]?></td>
                           <td><img src="../Admin_Pages/images/<?php echo $pro["Cake_Image"]?>" class="img-thumbnail" width="200" height="200"/></td>
                             <td><?php echo $pro["Cake_Price"]?></td> 
                              <td><?php echo $c["qty"]?></td>
                              <td><?php echo $pro["Cake_Price"] * $c["qty"]?></td>
            ...
            <?php
				 ...
				 {
				  ?>
                 <a href="Customer_Page.php"><input type="submit"  name="check_out" value="Check Out" class="btn btn-primary"/></a>
                 <?php
				 }
				 ?>
                 <?php 
