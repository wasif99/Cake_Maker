...
<head>
    ...
    <title>Show Category Items</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                              <thead>
                                <tr>
                                  <th scope="col" style="background-color:#000;color:#FFF;text-align:center;">Slider ID</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Slider Image</th><th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Description</th>
                              ...
                              <?php
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="text-align:center;background-color:#FFF;color:#000;"><?php  echo $row["S_Id"]?></td>
                                            <td style="text-align:center;background-color:#FFF;color:#000;"><?php  echo $row["S_Images"]?></td>
                                             <td style="text-align:center;background-color:#FFF;color:#000;"><?php  echo $row["Description"]?></td>
                    
                                              <td style="text-align:center;background-color:#FFF;color:#000;"><a href="Show_Slider.php?del_id=<?php echo $row["S_Id"] ?>"><span style="color:#FFF;"><img src="images/delete.png" width="35" height="35" /></span></a></td>   
                                                <td style="text-align:center;background-color:#FFF;color:#000;"><a href="Add_Category.php?edit_id=<?php echo $row["S_Id"] ?>"><span style="color:#FFF;"><img src="images/edite.png" width="35" height="35" /></a></span></td>                                     
                                        </tr>                                   
                                    </tbody>
                                    <?php
...
<!-------****Delete Action Start****--------->
 ...
 <?php 
		if(isset($_GET["del_id"]))
			...
			$query =mysqli_query($connection,"delete from  slider_table where S_Id = '".$del_catid."'");			
			}
