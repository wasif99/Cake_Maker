                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align:center;background-color:#FFF;color:#000;"><?php  echo $row["Cat_Name"]?></td>
                                              <td style="text-align:center;background-color:#FFF;color:#000;"><a href="Show_Category_Table.php?del_id=<?php echo $row["Cat_Id"] ?>"><span style="color:#FFF;"><img src="images/delete.png" width="35" height="35" /></span></a></td>   
                                                <td style="text-align:center;background-color:#FFF;color:#000;"><a href="Add_Category.php?edit_id=<?php echo $row["Cat_Id"] ?>"><span style="color:#FFF;"><img src="images/edite.png" width="35" height="35" /></a></span></td>                                     
                                        </tr>                                   
                                    </tbody>
                                    <?php
...
<!-------****Delete Action Start****--------->
 ...
 <?php 
		...
		if(isset($_GET["del_id"]))
			...
			$query =mysqli_query($connection,"delete from  category_table where Cat_Id = '".$del_catid."'");			
			}
