                            ...
                            <table class="table table-bordered">
                              ...
                              <tbody>
                                 <?php
									...
									$query = mysqli_query($connection,"select * from  view_table");
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="text-align:center;"><?php  echo $row["Cake_Id"]?></td>
                                            <td style="text-align:center;"><?php  echo $row["Cake_name"]?></td>
                                            <td style="text-align:center;"><?php  echo $row["Cake_flavour"]?></td>
                                            <td style="text-align:center;"><img width="50" height="50" src="images/<?php  echo $row["Cake_Image"]?>"/></td>
                                            
                                              <td style="text-align:center;"><?php  echo $row["Cake_Des"]?></td>
                                                <td style="text-align:center;"><?php  echo $row["Cake_Price"]?></td><td style="text-align:center;"><?php  echo $row["Cat_Name"]?></td>
                                              <td style="text-align:center;"><a href="Show_Items.php?del_id=<?php echo $row["Cake_Id"] ?>"><img src="images/delete.png" width="30" height="30" /></a></td>   
                                                <td style="text-align:center;"><a href="Add_Items.php?edit_id=<?php echo $row["Cake_Id"] ?>"><img src="images/edite.png" width="30" height="30" /></a></td>                                     
                                        </tr>                                   
                                    </tbody>
                                    <?php
