    ...
    <div id="right-panel" class="right-panel">
       ...
       <!----------****Edite Action Start****------------->
					 ...
					 if(isset($_GET["edit_id"]))
					 {
						 ...
						 $editsliderid = $_GET["edit_id"];
						 $query = mysqli_query($connection,"select * from slider_table where S_Id='".$editsliderid."'");
						 $tbl_row = mysqli_fetch_array($query);						
						 $proimg = $tbl_row["S_Images"];
       ...
       <!----------****Insert Action Start****------------->
					...
					if(isset($_POST["btn_insert"]))
					{
						  ...
						  if (!empty($_FILES["fileupload"]["name"]))
						{
						  ...
						  {
							$query = mysqli_query($connection,"insert into slider_table	(S_Images,Description) values('".$Filename."','".$descri."')");							
...
?>
       <!----------****Insert Action End****------------->
					...
					<div class="col-lg-12">
                    <div class="card">
                      <div class="card-header"><strong>Slider</strong><small> Form</small></div>
                      <div class="card-body card-block">
                      <form method="post" action="Add_Slider.php" enctype="multipart/form-data">
                        
                        <div class="form-group">
                        <input type="hidden" name="hideid" class="form-control"/>
                        </div>
                        <div class="form-group"><label class=" form-control-label"><b>Select Your Image</b></label>
                        <input type="file" name="fileupload" class="form-control" />
                        </div>    
                                  <div class="form-group"><label class=" form-control-label"><b>Enter Your Description</b></label>
                        <textarea rows="8" name="s_des" class="form-control" style="height:100px;"><?php echo @$cake_des?>
                        
                        </textarea>   
                          </div>
                                   
                        <div class="form-group">
                        <input type="submit" name="btn_insert" value="Insert" class="btn btn-info " />    
                          </div>            
                        </div>
                        <div class="form-group">
