...
<body>
    ...
    <div id="right-panel" class="right-panel">
		...
		if(isset($_GET["del_id"]))
			...
			$query =mysqli_query($connection,"delete from   user_table where User_ID = '".$del_catid."'");			
			}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                              <thead>
                                <tr>
                                  <th scope="col" style="background-color:#000;color:#FFF;text-align:center;">User ID</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF; text-align:center;">User Name</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">User Password</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">User Email</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">User Phone</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Gender</th>
                                  <th scope="col" style="background-color:#000;color:#FFF;text-align:center;">Action</th>
                                </tr>
                              </thead>
                              <tbody>
                                 <?php
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align:center;"><?php  echo $row["User_Password"]?></td>
                                            
                                              <td style="text-align:center;"><?php  echo $row["User_Email"]?></td>
                      <td style="text-align:center;"><?php  echo $row["User_Phone"]?></td>
                      <td style="text-align:center;"><?php  echo $row["Gender"]?></td>
                                              <td style="text-align:center;"><a href="Show_User.php?del_id=<?php echo $row["User_ID"] ?>"><img src="images/delete.png" width="30" height="30" /></a></td>   
