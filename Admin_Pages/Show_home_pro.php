...
<body>
    ...
    <div id="right-panel" class="right-panel">
		...
		if(isset($_GET["del_id"]))
			...
			$query =mysqli_query($connection,"delete from  home_pro_table where H_Id = '".$del_catid."'");			
			}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                              <thead>
                                <tr>
                                  <th scope="col" style="background-color:#000;color:#FFF;text-align:center;">Cake ID</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF; text-align:center;">Cake Name</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Flavour Name</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Image</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Description</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Price</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Events</th>
                              ...
                              <tbody>
                                 <?php
									...
									$query = mysqli_query($connection,"select * from  view_home");
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="text-align:center;"><?php  echo $row["H_Id"]?></td>
                                            <td style="text-align:center;"><?php  echo $row["H_Name"]?></td>
                                            <td style="text-align:center;"><?php  echo $row["H_Flavour"]?></td>
                                            <td style="text-align:center;"><img width="50" height="50" src="images/<?php  echo $row["H_Image"]?>"/></td>
                                            
                                              <td style="text-align:center;"><?php  echo $row["Description"]?></td>
                                                <td style="text-align:center;"><?php  echo $row["H_Price"]?></td><td style="text-align:center;"><?php  echo $row["Cat_Name"]?></td>
                                              <td style="text-align:center;"><a href="Show_home_pro.php?del_id=<?php echo $row["H_Id"] ?>"><img src="images/delete.png" width="30" height="30" /></a></td>   
                                                <td style="text-align:center;"><a href="Add_Home_Pro.php?edit_id=<?php echo $row["H_Id"] ?>"><img src="images/edite.png" width="30" height="30" /></a></td>                                     
                                        </tr>                                   
                                    </tbody>
                                    <?php
